...
$(".btn.depth").on('click', function(event){
    ...
    $('.background-img').css('background-image', 'url("slider/depth.png")')    
});
$(".btn.normals").on('click', function(event){
    ...
    $(".btn.occlusion").removeClass('focus')
    $(".btn.flow").removeClass('focus')
    $('.background-img').css('background-image', 'url("slider/normals.png")')    
});
$(".btn.occlusion").on('click', function(event){
    ...
    $(".btn.flow").removeClass('focus')
    $('.background-img').css('background-image', 'url("slider/occlusion.png")')    
});
$(".btn.flow").on('click', function(event){
    ...
    $('.background-img').css('background-image', 'url("slider/flow.png")')    
});